 ...
 * @author gilmanma
 */
public class StaticHeuristicWeight extends HeuristicWeight {
    
    public StaticHeuristicWeight(double epsilon) {
        super(epsilon);
    }
    
    public StaticHeuristicWeight(double epsilon, ProfileHMM hmm) {
        super(epsilon, hmm);
    }
